Update in progress: for the moment scripts are still more or less calibrated for data used in published article. I am working on to make scripts easier to run on general data. Also building a clearer documentation. This should be done within few weeks, before end of october
